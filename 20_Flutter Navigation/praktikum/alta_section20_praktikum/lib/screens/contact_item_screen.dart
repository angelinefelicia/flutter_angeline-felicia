import 'package:alta_section20_praktikum/models/contact_model.dart';
...
class _ContactItemScreenState extends State<ContactItemScreen> {
  ...
  Widget build(BuildContext context) {
    // navigator dengan named
    final onCreate =
        ModalRoute.of(context)!.settings.arguments as Function(ContactModel);
